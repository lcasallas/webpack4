...
module.exports = {
		...
		rules: [
			...
			},
			{
				...
				use: [
					// 'style-loader', //inyecta. se comenta porque estamos generando el archivo css con el plugin.
					{
						loader: MiniCSSExtractPlugin.loader, //Extrae el css, se utiliza para produccion.
					},
					'css-loader', //permite importacion.
					'stylus-loader',
				],
	...
	plugins: [
		...
		new webpack.DllReferencePlugin({
			manifest: require('./modules-manifest.json'), //el archivo manifest que me creo webpack.dll.config.js
		}),
	],
	optimization: {
